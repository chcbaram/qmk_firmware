...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, KC_QUOT,
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______,          KC_F18,                   MO(3), _______, _______, _______
    ),
    [3] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [4] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F11, KC_F12,
